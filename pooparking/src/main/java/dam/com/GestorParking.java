...
public class GestorParking {
    ...
    public String toString() {
        return "GestorParking [places=" + places + ", tiquets=" + tickets.findAll() + "]";
    }
}